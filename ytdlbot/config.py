...
APP_ID: int = int(os.getenv("APP_ID", "24519654"))
APP_HASH = os.getenv("APP_HASH", "1ccea9c29a420df6a6622383fbd83bcd")
TOKEN = os.getenv("TOKEN", "7696666754:AAH2TzzicO9hCSI5QK3_yipiiYWggkS6WHQ")
